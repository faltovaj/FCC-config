...
evtsvc.input = 'CLD_NobleECAL_sim.root'
...
detectors_to_use=["FCCee/CLD/compact/CLD_o4_v05/CLD_o4_v05.xml",
                  ]
...
out = PodioOutput("PodioOutput", filename = "my_pandora_output.root")
